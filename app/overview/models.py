...
class OverviewProfile(models.Model):
...
class OverviewRequest(models.Model):
    profile = models.ForeignKey(OverviewProfile, on_delete=models.CASCADE, null=True, blank=True)
    created = models.DateTimeField(auto_now_add=True)
