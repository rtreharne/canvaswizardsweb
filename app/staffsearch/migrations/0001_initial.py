    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='staffsearch.department')),
            ],
            options={
                'ordering': ('-created_at',),
                'abstract': False,
        ...
        migrations.AddField(
            ...
            name='institute',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='staffsearch.institute'),
        ),
    ]
